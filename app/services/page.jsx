            ...
            return (
              ...
              >
                ...
                <div className="w-full flex justify-between items-center">
                  ...
                  <Link
                    href={service.href}
                    className="w-[70px] h-[70px] rounded-full bg-white group-hover:bg-accent transition-all duration-700 flex justify-center items-center hover:-rotate-45"
                  >
                    <PiArrowDownRightBold className="text-primary text-3xl" />
                  </Link>
                </div>
                {/* title */}
                <h2 className="text-[42px] font-bold leading-none text-white group-hover:text-accent transition-all duration-700">
                  {service.title}
                </h2>
                {/* description */}
