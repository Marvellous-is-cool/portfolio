              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="btd">
                      Bots Development/Management
                    </SelectItem>
                    <SelectItem value="gra">Graphics Design</SelectItem>
                    <SelectItem value="aup">
                      Automation / Python Scripting
                    </SelectItem>
                    <SelectItem value="seo">SEO</SelectItem>
                    <SelectItem value="mba">Mobile App Development</SelectItem>
                    <SelectItem value="api">API Integration</SelectItem>
                    <SelectItem value="prd">Presentation Design</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              {/* textarea */}
