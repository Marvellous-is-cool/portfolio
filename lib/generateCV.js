...
export async function generateCvPdf() {
  ...
  let contentY = height - 220; // Increased gap between header and content
  const leftColumnX = margin;
  const rightColumnX = width / 2 + 20; // Adjusted right column position
  const sectionSpacing = 140; // Reduced section spacing for better distribution
